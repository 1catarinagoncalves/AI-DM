...
// nomes e não palavras. Os 5 campos de texto são a versão inglesa da mesma cena, não tradução
// literal: mesma premissa, prosa escrita em inglês.
//
// primaryQuestTitle/primaryQuestDescription: removidos na US-155 (a quest passou a vir só do
// artefato de aventura gerado, US-153) e REINTRODUZIDOS na US-217 — o ramo "Aventura pronta"
// (US-216) pula o motor de geração inteiro, então volta a precisar de uma quest fixa por
// classe. O ramo "Criar minha história" continua 100% no motor, sem ler estes dois campos.
  ...
  hooks: [
    {
      ...
      primaryQuestTitle: 'A Prova do Guerreiro',
      primaryQuestDescription: 'Complete a prova que os anciãos da tribo impuseram e prove que merece o posto de guerreiro respeitado.',
    ...
    },
    {
      ...
      primaryQuestTitle: 'Vencer o Jogo dos Feéricos',
      primaryQuestDescription: 'Vença os Eladrin no próprio jogo de charme e astúcia e conquiste a chave que abre o baú cobiçado.',
    ...
    },
    {
      ...
      primaryQuestTitle: 'Reacender a Chama Sagrada',
      primaryQuestDescription: 'Descubra por que o fogo morreu dentro da cidade e devolva a chama sagrada antes que a escuridão tome as ruas.',
    ...
    },
    {
      ...
      primaryQuestDescription: 'Encontre o que quebrou o equilíbrio da mata selvagem e resolva a ameaça, seja curando a terra, seja caçando o que a corrompeu.',
    ...
    },
    {
      ...
      primaryQuestTitle: 'Cruzar o Campo Até a Fortaleza',
      primaryQuestDescription: 'Conduza o batalhão em segurança pelo campo infestado de monstros até alcançar a fortaleza do outro lado.',
    ...
    },
    {
      ...
      primaryQuestTitle: 'Alcançar o Assassino',
      primaryQuestDescription: 'Persiga o assassino pelos telhados da cidade e o alcance antes que desapareça nas sombras urbanas.',
    ...
    },
    {
      ...
      primaryQuestTitle: 'Desmascarar o Demônio',
      primaryQuestDescription: 'Descubra qual rosto da vila esconde o demônio infiltrado antes que o plano dele se complete.',
    ...
    },
    {
      ...
      primaryQuestTitle: 'Rastrear os Fragmentos do Céu',
      primaryQuestDescription: 'Contenha a ameaça criada pelo cometa que caiu perto e rastreie os quatro fragmentos restantes espalhados pela região.',
    ...
    },
    {
      ...
      primaryQuestTitle: 'Roubar a Lágrima de Solane',
      primaryQuestDescription: 'Infiltre-se na torre trancada de Mestre Corvane e escape com a Lágrima de Solane sem ser flagrado pelos guardas.',
    ...
    },
    {
      ...
      primaryQuestTitle: 'Reacender o Farol',
      primaryQuestDescription: 'Descubra o que apagou o farol mais antigo da costa e reacenda a luz antes que a tempestade traga o navio para as pedras.',
    ...
    },
    {
      ...
      primaryQuestTitle: 'Colher a Sangue-de-Lua',
      primaryQuestDescription: 'Atravesse o arboreto desperto pela lua cheia e colha a Sangue-de-Lua exigida pelo seu patrono.',
    ...
    },
    {
      ...
      primaryQuestTitle: 'Escapar do Tomo',
      primaryQuestDescription: 'Decifre as regras do reino mágico dentro do tomo e encontre a saída antes que o livro acabe com você.',
    ...
    },
    {
      ...
      primaryQuestTitle: 'Responder ao Chamado',
      primaryQuestDescription: 'Descubra o que o mundo espera de {characterName} agora que sua vocação de {characterClass} foi reconhecida.',
  ...
  hooks: [
    {
      ...
      primaryQuestTitle: "The Warrior's Trial",
      primaryQuestDescription: 'Complete the trial the elders set before the tribe and prove you deserve the rank of a warrior who leads.',
    ...
    },
    {
      ...
      primaryQuestTitle: 'Outplay the Fey',
      primaryQuestDescription: "Beat the Eladrin at their own game of charm and cunning to win the key to the coveted chest.",
    ...
    },
    {
      ...
      primaryQuestTitle: 'Relight the Sacred Flame',
      primaryQuestDescription: 'Find out why fire has died inside the city and restore the sacred flame before the dark swallows the streets.',
    ...
    },
    {
      ...
      primaryQuestTitle: "Restore the Wood's Balance",
      primaryQuestDescription: 'Find what broke the balance of the wild wood and set it right, whether by healing the land or hunting down what corrupted it.',
    ...
    },
    {
      ...
      primaryQuestTitle: 'Cross the Field to the Fortress',
      primaryQuestDescription: 'Lead the battalion safely across the monster-infested field and reach the fortress on the far side.',
    ...
    },
    {
      ...
      primaryQuestTitle: 'Catch the Killer',
      primaryQuestDescription: 'Chase the killer across the city rooftops and catch him before he vanishes into the urban sprawl.',
    ...
    },
    {
      ...
      primaryQuestTitle: 'Unmask the Demon',
      primaryQuestDescription: 'Work out which face in the village hides the infiltrated demon before its plan is complete.',
    ...
    },
    {
      ...
      primaryQuestTitle: 'Track the Falling Fragments',
      primaryQuestDescription: 'Contain the threat born from the comet that fell nearby and track down the four remaining fragments scattered across the region.',
    ...
    },
    {
      ...
      primaryQuestTitle: "Steal Solane's Tear",
      primaryQuestDescription: "Break into Master Corvane's locked tower and escape with Solane's Tear without the guards noticing.",
    ...
    },
    {
      ...
      primaryQuestTitle: 'Relight the Lighthouse',
      primaryQuestDescription: 'Find out what put out the oldest lighthouse on the coast and relight it before the storm drives the ship onto the rocks.',
    ...
    },
    {
      ...
      primaryQuestTitle: 'Harvest the Moonsblood',
      primaryQuestDescription: "Cross the arboretum woken by the full moon and harvest the Moonsblood your patron demands.",
    ...
    },
    {
      ...
      primaryQuestTitle: 'Escape the Tome',
      primaryQuestDescription: 'Work out the rules of the realm inside the tome and find the way out before the book finishes what it started.',
    ...
    },
    {
      ...
      primaryQuestTitle: 'Answer the Call',
      primaryQuestDescription: "Find out what the world expects of {characterName} now that their calling as {characterClass} has been recognized.",
