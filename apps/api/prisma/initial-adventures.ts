...
// literal: mesma premissa, mesma quest, prosa escrita em inglês.
  ...
  hooks: [
    {
      ...
      primaryQuestTitle: 'Prove your worth and rise in the tribe',
      primaryQuestDescription: 'Pass the trial the elders set for {characterName} and win the respect that opens the way to the tribe\'s higher seats — by strength, by fury, and by the name earned in battle.',
    ...
    },
    {
      ...
      primaryQuestTitle: 'Win the key to the chest at the fey court',
      primaryQuestDescription: 'Navigate the strange, shifting rules of a fey ball and pry the key to a certain chest out of the Eladrin — charming, persuading or lying your way through without ever falling into the word-traps they love to set. Force will not open this door; only the tongue of {characterName}.',
    ...
    },
    {
      ...
      primaryQuestTitle: 'Find out why fire died inside the city',
      primaryQuestDescription: 'Investigate why no flame — common or magical — will catch within the walls, confirm whether the God of Flame truly perished, and stop the cause before the trolls and the thieves take the city in the dark. The faith of {characterName} may be the last light left.',
    ...
    },
    {
      ...
      primaryQuestTitle: 'Restore the balance of the wood',
      primaryQuestDescription: 'Find out what came in — a monstrosity, an aberration, a blight — and drove the beasts to madness, then decide how {characterName} brings order back: calming and healing the maddened animals, or hunting down and destroying whatever corrupted them.',
    ...
    },
    {
      ...
      primaryQuestTitle: 'Get the battalion across to the fortress alive',
      primaryQuestDescription: 'Cross an open field infested with monsters at the head of a battalion and reach the fortress on the far bank. {characterName} has to place the soldiers, choose when to fight and when to push on, and arrive with as many of them still breathing as possible.',
    ...
    },
    {
      ...
      primaryQuestTitle: 'Run the killer down before he gets away',
      primaryQuestDescription: 'Chase a fast killer through the alleys, walls and rooftops of the city without losing sight of him, and put him down along with his hired muscle once he is cornered. The speed of {characterName} is the only thing that can match his.',
    ...
    },
    {
      ...
      primaryQuestTitle: 'Unmask the shapeshifting demon and break its plan',
      primaryQuestDescription: 'Search a village where a shapeshifting demon hides behind a human face, using talk, instinct and the divine gift of {characterName} to draw it out — then stop it and undo the harm it spreads, whether that is poisoned food, sickness, or worse.',
    ...
    },
    {
      ...
      primaryQuestTitle: 'Contain the fragment in the goblin village and track the other comets',
      primaryQuestDescription: 'Get into the goblin village the comet changed — where the goblins now command fire, think as one, and have grown past their natural size — and use the artifact given to {characterName} to contain the fragment. Then find where the other four pieces came down, and what they woke.',
    ...
    },
    {
      ...
      primaryQuestTitle: 'Steal Solane\'s Tear from the top of Corvane\'s tower',
      primaryQuestDescription: 'Climb the tower of Master Corvane the collector — traps, locks and his private guard the whole way up — reach the chamber at the top, take the gem called Solane\'s Tear, and get out whole. {characterName} can climb, pick, lie or slip past, so long as nobody notices until it is far too late.',
    ...
    },
    {
      ...
      primaryQuestTitle: 'Relight the lighthouse before the ship and the storm',
      primaryQuestDescription: 'Find out what put the light out — a small fire elemental that was bound inside the beam and is now loose — and catch it again, or find another source bright enough, before a passenger ship rounds the coast in three days, right as the storm arrives. The power of {characterName} may be the only flame equal to it.',
    ...
    },
    {
      ...
      primaryQuestTitle: 'Take the Moonsblood from the arboretum and get out alive',
      primaryQuestDescription: 'Enter the arboretum by night to "acquire" the Moonsblood the patron of {characterName} is owed, and escape when the full moon wakes the plants — alive now, and hungry — that rise to stop the theft.',
    ...
    },
    {
      ...
      primaryQuestTitle: 'Learn the rules of the realm inside the tome and escape it',
      primaryQuestDescription: 'Survive a magical realm with rules of its own, where thinking fast counts for more than fighting, and work out how {characterName} undoes the magic holding you there — before the place finishes with you.',
    ...
    },
    {
      ...
      primaryQuestTitle: 'Find out why your calling was recognized',
      primaryQuestDescription: 'Look into that first call without assuming any rule specific to your class.',
