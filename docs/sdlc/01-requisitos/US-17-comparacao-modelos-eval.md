...
- **Slice 2 — execução (feito, 2026-07-10):** matriz gerada, artefato em `evals/reports/2026-07-10.md` (gerado por execução, gitignored pela US-36 — não versionado). Achados da 1ª execução real:
