...
**Relacionado:** [US-108](./US-108-tabela-de-modificadores-do-srd-2024.md) (o mesmo `Rule.json`, o mesmo pipeline) · [US-109](./US-109-bonus-circunstancial-no-teste-de-d20.md) (o outro termo da soma do d20 test) · [US-75](./US-75-dimensao-de-proveniencia-no-ledger.md) (proveniência no ledger — a mesma disciplina aplicada ao número) · [US-55](./US-55-prompt-caching-do-dm.md) / [ADR 007](../../adr/007-camadas-do-prompt-por-volatilidade.md) (camadas do prompt por volatilidade) · [ADR 003](../../adr/003-sistemas-como-dado.md) (sistema como dado) · [US-159](./US-159-orcamento-de-encontro-lgmrd.md) (a régua de orçamento de encontro correta para [US-150](./US-150-gate-antes-de-persistir-aventura-gerada.md)/[US-152](./US-152-statblocks-papel-orcamento.md) — não esta story, ver *Fora do escopo*)
...
- **Orçamento de encontro (o que [US-150](./US-150-gate-antes-de-persistir-aventura-gerada.md)/[US-152](./US-152-statblocks-papel-orcamento.md) citavam esta story para obter — corrigido em 17/08/2026).** `difficultyClasses` (5/10/15/20/25/30) é a escala de **CD de teste de habilidade** — compara o total de um d20 test contra um alvo. Orçamento de encontro compara **soma de CR de monstros** contra um teto por nível de personagem — dado diferente, sem sobreposição. Conferido no repo: nenhum artefato do pipeline `scripts/srd` tem tabela de orçamento de encontro (`Rule.json` sem `Encounter`; `d20-tests.mjs` só extrai `difficultyClasses`/`abilityChecks`). Esta story **não produz** esse dado — quem produz é a [US-159](./US-159-orcamento-de-encontro-lgmrd.md), que usa o *Lazy Encounter Benchmark* já presente em `5e_Monster_Builder.json` (LGMRD, já baixado pela US-145), em vez de uma tabela de XP do SRD 2024.
