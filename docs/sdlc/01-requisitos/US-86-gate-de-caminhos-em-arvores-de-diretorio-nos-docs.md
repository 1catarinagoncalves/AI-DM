...
- [docs/sdlc/03-implementacao/convencoes.md](../03-implementacao/convencoes.md) — as duas árvores saíram em 28/07; sobraram as mentiras em **prosa**, fora do alcance de qualquer um dos gates (módulos NestJS `campaign`/`ingestion`, *"uma tool por arquivo"*, `prisma/seed.ts` na raiz). Material da story de auditoria daquele arquivo.
