...
**Relacionado:** [US-150](./US-150-gate-antes-de-persistir-aventura-gerada.md) (gate, verificação 3 — já filtra por role em `MONSTER_ROLE_CR`, efeito equivalente a "só `combat`") · [US-171](./US-171-encontros-de-combate-entram-no-ledger.md) (`encounterNpcEntities` ganha filtro `type === 'combat'`) · US-163 (`N=8` é constante desta story, não preferência do jogador) · [US-187](./US-187-distribuicao-tematica-de-locationid-baseada-em-registry.md) (distribuição temática de `locationId`, depende desta story primeiro) · [US-190](./US-190-antagonista-vira-passo-proprio-entre-segredos-e-encontros.md) (`antagonist` já chega pronto de `generateAntagonist`, chamada própria ANTES do `Promise.all` — implementado)
