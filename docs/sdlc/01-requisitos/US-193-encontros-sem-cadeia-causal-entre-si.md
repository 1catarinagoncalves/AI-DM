...
**Status:** 🚧 Em progresso — schema/prompt/guard implementados; eval de embaralhamento extraída para [US-195](./US-195-eval-de-embaralhamento-da-cadeia-causal.md) (achado: heurística determinística testada com dados reais não discriminou de forma confiável, ver aquela story)
