...
- **Custo de token é pequeno e estático:** 6 linhas curtas, na camada cacheada. Não mexe na fronteira de cache; mexe uma vez no baseline medido pela [US-104](./US-104-baseline-de-cache-do-prompt-pos-pin.md).
