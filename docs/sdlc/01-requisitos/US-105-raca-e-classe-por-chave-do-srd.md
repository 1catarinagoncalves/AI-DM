...
**Status:** ✅ Implementada · **precedência revista em 15/08/2026** ([ADR 009 §8](../../adr/009-uniao-dos-srd-5-1-e-5-2.md) inverte 2024→5.1; ver [US-138](./US-138-catalogo-racas-srd-5-1-como-referencia.md) e [US-139](./US-139-catalogo-classes-marshal-a5e-adventurers-guide.md)) — os critérios de aceite abaixo descrevem a precedência **original** (2024 vence), hoje substituída
