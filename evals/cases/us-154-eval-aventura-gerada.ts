...
const adventure: GeneratedAdventure = {
  ...
  npcs: [
    { id: 'npc-1', name: 'Ilvaine Torncroft', role: 'anciã da vila' },
    { id: 'npc-2', name: 'Doran Ashwick', role: 'ferreiro rude' },
    { id: 'npc-3', name: 'Sable Winterhollow', role: 'caçadora desconfiada' },
    { id: 'npc-4', name: 'Corvin Halewood', role: 'sacerdote itinerante' },
    { id: 'npc-5', name: 'Wrenna Duskfell', role: 'criança órfã' },
    { id: 'npc-6', name: 'Garrick Nightbrook', role: 'estalajadeiro nervoso' },
    { id: 'npc-7', name: 'Brute', role: 'Brute' },
  ],
  secrets: [
  ...
  encounters: [{
    id: 'encounter-1', locationId: 'loc-2', npcIds: ['npc-7'], type: 'combat',
    behaviors: 'A entidade sonda o poço em busca de quem a mantém selada.',
    goal: 'Confrontar o que desperta sob a Casa da anciã.',
    complications: 'O selo enfraquece a cada rodada de combate.',
    unlocks: 'A confirmação de que Ilvaine sacrificou o filho para selar o poço.',
  }],
