...
## Corpus Check
- 490 files · ~1,027,195 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3833 nodes · 5286 edges · 307 communities (252 shown, 55 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 8 edges (avg confidence: 0.59)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ec9fa62d`
...
Cohesion: 0.10
Nodes (10): AdventureService, Injectable, AiService, applyInventoryDeltas(), buildClosingPrompt(), buildLocationsAndNpcsPrompt(), buildPremissaPrompt(), buildSecretsPrompt() (+2 more)
...
### Community 210 - "Modelo de Dados — AI Dungeon Master"
Cohesion: 0.40
...
### Community 244 - "shared/src/index.ts"
Cohesion: 0.20
...
Cohesion: 0.07
Nodes (27): AdventureModule, Module, AiModule, Module, AppModule, Module, AuthModule, Module (+19 more)
...
Cohesion: 0.05
Nodes (35): AnchoredRoll, ANTAGONIST_LOCATION_PROSE_SCHEMA, ANTAGONIST_SCHEMA, ChatInput, CLOSING_SCHEMA, coercedStringArray, composeMainQuestText(), EncounterSkeletonEntry (+27 more)
...
### Community 316 - "SystemService"
Cohesion: 0.18
Nodes (8): SystemController, ApiOperation, ApiTags, Controller, Get, UseGuards, SystemService, Injectable
...
## Knowledge Gaps
- **2154 isolated node(s):** `História`, `Achado (o que já foi tentado, com números reais)`, `Dentro do escopo`, `Fora do escopo`, `Opções (para decidir no início desta story, não implementar as três)` (+2149 more)
...
- **Why does `ADR-0005` connect `dm-system.ts` to `ingest.mjs`, `roll-content.ts`, `seed.ts`?**
...
- **What connects `História`, `Achado (o que já foi tentado, com números reais)`, `Dentro do escopo` to the rest of the system?**
