# Graph Report - AI DM  (2026-08-25)

## Corpus Check
- 497 files · ~1,028,802 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3865 nodes · 5328 edges · 320 communities (260 shown, 60 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 8 edges (avg confidence: 0.59)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `74052bf7`
...
## Communities (320 total, 60 thin omitted)
...
Cohesion: 0.15
Nodes (9): applyInventoryDeltas(), CLOSING_SCHEMA, composeMainQuestText(), OPENING_SCENE_SCHEMA, Evt, fakePrisma(), { salvage, genObj }, service() (+1 more)
...
Cohesion: 0.13
Nodes (18): ChallengeOptionGroup(), GENDERS, groupToolsByCategory(), lines(), optionCardClass(), parseDeity(), POINT_COST, rollRandom() (+10 more)
...
### Community 93 - "backlog-motor-de-geracao-de-aventuras.md"
Cohesion: 0.05
Nodes (36): US-34 — Qualidade cinematográfica da narração do AI DM, US-35 — Estado de cena estruturado já na abertura da aventura, US-36 — Eval de qualidade da narração do DM, US-37 — Nível cinematográfico mantido em todos os turnos, US-38 — Rolagens ancoradas na ficha, US-39 — Identidade narrativa do personagem, US-40 — Divindade / patrono do personagem, US-41 — Features de classe conhecidas pelo mestre (+28 more)
...
Cohesion: 0.16
Nodes (13): LoginPage(), AuthNav(), BrandName(), gameProps, { getTurns, setLocale }, LOCALE_STORAGE_KEY, LocaleContext, LocaleContextValue (+5 more)
...
Cohesion: 0.12
Nodes (9): composeStartBriefing(), AiService, buildClosingPrompt(), buildLocationsAndNpcsPrompt(), buildPremissaPrompt(), buildSecretsPrompt(), characterAnchors(), logExtractionEndpoint() (+1 more)
...
### Community 168 - "api/package.json"
Cohesion: 0.50
...
Cohesion: 0.20
Nodes (10): AuthGuard, OptionalAuthGuard, AuthUser, CurrentUser, payloadToUser(), b64urlToBuffer(), JwtPayload, verifyJwt() (+2 more)

### Community 178 - "dm.tsx"
Cohesion: 0.15
Nodes (18): emptyState(), HomeHero(), HubCharacter, { listCharacters, deleteCharacter }, useLocale(), LocaleToggle(), BtnProps, cn() (+10 more)
...
### Community 210 - "AdventureController"
Cohesion: 0.24
...
Cohesion: 0.12
Nodes (14): base, CreateCharacterDto, CreateCharacterSchema, configForLocale(), getSystemCached(), getSystemsCached(), LocaleMap, localeOfUser() (+6 more)
...
### Community 280 - "character.service.test.ts"
Cohesion: 0.25
...
Cohesion: 0.09
Nodes (22): 1. Contexto, 2. Decisão, 3.1 Revisão da decisão 6 (02/08/2026): o Free herda o SRD, 3.2 Correção de procedência (03/08/2026): o kit inicial é CC-BY, não OGL, 3.3 Segundo publisher no config (09/08/2026): `a5e-ag` entra sob a mesma regra de licença única, 3.4 Exceção pontual (13/08/2026): `ability` de `Culture`/`Engineering` não vem do Open5e, 3. Decisões-chave e justificativas, 4. A descoberta que só apareceu cutucando o dataset (+14 more)

### Community 288 - "us-171-eval-combatente-no-ledger.ts"
Cohesion: 0.40
Nodes (4): adventure, block(), seedEncounterEntities(), sheet

### Community 289 - "CharacterController"
Cohesion: 0.14
Nodes (12): CharacterController, ApiBearerAuth, ApiBody, ApiOperation, ApiTags, Body, Controller, Get (+4 more)

### Community 291 - "Checklist de Deploy — AI Dungeon Master"
Cohesion: 0.33
...
### Community 301 - "Repositórios de referência — registro e regra de uso"
Cohesion: 0.33
...
### Community 304 - "US-200 — O item que a ficção entrega existe no servidor (e o que ela tira vai para algum lugar)"
Cohesion: 0.13
Nodes (15): A proposta, Contexto e motivação, Critérios de aceite (fase A), Escopo, Fase A — medir (dentro do escopo, custo zero), Fase B — condicionada ao número (fora desta entrega, decidida por ela), Fora do escopo, História (+7 more)
...
## Knowledge Gaps
- **2177 isolated node(s):** `História`, `Os três canais`, `Por que os canais 2 e 3 são a MESMA story`, `Por que isso é regressão de produto, não bug de implementação`, `Dentro do escopo` (+2172 more)
...
- **What connects `História`, `Os três canais`, `Por que os canais 2 e 3 são a MESMA story` to the rest of the system?**
