...
- US-153-aventura-deixa-de-ser-derivada-da-classe.md
- seed-ledger.ts
...
## Communities (389 total, 54 thin omitted)
...
Cohesion: 0.10
Nodes (27): PlayPage(), Props, BackgroundPanel(), CharacterBackground, ClassFeature, FeaturesPanel(), ORIGIN_TAG_KEY, ARMOR_CATEGORY_LABEL (+19 more)
...
### Community 258 - "Atribuição — Lazy GM Resource Document + Lazy GM's 5e Monster Builder"
Cohesion: 0.29
...
### Community 310 - "011-observabilidade-em-camadas.md"
Cohesion: 0.11
...
### Community 313 - "backlog-aventuras-autorais-lazygm.md"
Cohesion: 0.20
...
Cohesion: 0.14
Nodes (10): POST(), { handlers, auth }, secretKey(), signApiToken(), ADR-0006, providers, loadProviders(), apiAuthHeader() (+2 more)
...
### Community 368 - "US-36 — Eval de qualidade da narração do DM"
Cohesion: 0.39
...
## Knowledge Gaps
- **2759 isolated node(s):** `História`, `O problema observado`, `Por que a solução atual não basta`, `A proposta`, `Dentro do escopo` (+2754 more)
