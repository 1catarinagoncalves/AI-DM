...
## Corpus Check
- 412 files · ~872,695 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3009 nodes · 4086 edges · 253 communities (205 shown, 48 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 8 edges (avg confidence: 0.59)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `496119d2`
...
Cohesion: 0.06
Nodes (33): dotenv-cli, knip, devDependencies, dotenv-cli, knip, typescript, name, packageManager (+25 more)
...
Cohesion: 0.19
Nodes (9): AuthGuard, OptionalAuthGuard, Injectable, CurrentUser, payloadToUser(), b64urlToBuffer(), JwtPayload, verifyJwt() (+1 more)

### Community 178 - "dm.tsx"
Cohesion: 0.13
Nodes (19): LoginPage(), BrandName(), emptyState(), HomeHero(), HubCharacter, { listCharacters, deleteCharacter }, BtnProps, cn() (+11 more)
...
Cohesion: 0.10
Nodes (17): base, CreateCharacterDto, CreateCharacterSchema, SystemController, ApiOperation, ApiTags, Controller, Get (+9 more)
...
### Community 228 - "Repositórios de referência — registro e regra de uso"
Cohesion: 0.33
...
### Community 247 - "US-121-catalogo-backgrounds-a5e-adventurers-guide.md"
Cohesion: 0.38
Nodes (5): US-39 — Identidade narrativa do personagem, US-41 — Features de classe conhecidas pelo mestre, US-42 — Magias conhecidas pelo mestre, US-43 — Calibração do peso dos traços de identidade, US-45 — Background visível na ficha do personagem
...
### Community 250 - "US-125 — Adventures & Advancement, conexão e memento da origem no prompt do Mestre"
Cohesion: 0.20
...
### Community 251 - "Checklist de Deploy — AI Dungeon Master"
Cohesion: 0.33
...
### Community 252 - "Modificadores de atributo — tabela do SRD 2024"
Cohesion: 0.40
...
## Knowledge Gaps
- **1661 isolated node(s):** `História`, `O problema observado`, `Por que a solução atual não basta`, `A proposta`, `Dentro do escopo` (+1656 more)
...
- **Why does `US-47 — Ingestão do SRD 5e (2024) como dado do sistema` connect `US-105-raca-e-classe-por-chave-do-srd.md` to `US-121-catalogo-backgrounds-a5e-adventurers-guide.md`, `US-110-tabela-de-testes-de-habilidade-do-srd-2024.md`, `backlog-motor-de-geracao-de-aventuras.md`, `backlog-aventuras-autorais-lazygm.md`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `US-108 — Tabela de modificadores do SRD 2024 como fonte da regra` connect `US-108 — Tabela de modificadores do SRD 2024 como fonte da regra` to `US-110-tabela-de-testes-de-habilidade-do-srd-2024.md`?**
