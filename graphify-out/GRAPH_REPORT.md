...
## Corpus Check
- 447 files · ~910,880 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3277 nodes · 4503 edges · 282 communities (223 shown, 59 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 8 edges (avg confidence: 0.59)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `29afef9b`
...
## Communities (282 total, 59 thin omitted)
...
Cohesion: 0.13
Nodes (16): ADR-0003, abilityCheckTable(), BACKGROUND_LABELS, backgroundFieldText(), buildDmSystemPrompt(), buildOpeningInstruction(), buildTurnStateBlock(), CharacterBackground (+8 more)
...
Cohesion: 0.09
Nodes (19): AnchoredRoll, buildLocationsAndNpcsPrompt(), ChatInput, CLOSING_SCHEMA, ExtractedScene, LOCATIONS_AND_NPCS_SCHEMA, normName(), OPENING_ENTITIES_SCHEMA (+11 more)
...
### Community 252 - "011-observabilidade-em-camadas.md"
Cohesion: 0.10
...
### Community 253 - "monster-roles.ts"
Cohesion: 0.29
...
Cohesion: 0.25
Nodes (10): AREA_TYPES, SETTINGS, TONES, rollAdventure(), RolledAdventure, RolledAdventureContent, AdventureRegistry, AdventureRegistryOverrides (+2 more)
...
### Community 263 - "character.service.ts"
Cohesion: 0.15
...
### Community 268 - "adventure.service.ts"
Cohesion: 0.23
Nodes (7): CreateAdventureDto, GateResult, findOccupiedLocationTitle(), seedLedgerFromGeneratedAdventure(), resolveHookTemplate(), resolveInitialHook(), ADR-0002

### Community 269 - "AiService"
Cohesion: 0.13
Nodes (5): AiService, buildClosingPrompt(), buildSecretsPrompt(), logExtractionEndpoint(), Injectable

### Community 271 - "backlog-aventuras-autorais-lazygm.md"
Cohesion: 0.27
...
### Community 274 - "US-110-tabela-de-testes-de-habilidade-do-srd-2024.md"
Cohesion: 0.17
...
### Community 275 - "[adventureId]/page.tsx"
Cohesion: 0.17
Nodes (8): POST(), Props, { handlers, auth }, secretKey(), signApiToken(), ADR-0006, apiAuthHeader(), config

### Community 276 - "US-121-catalogo-backgrounds-a5e-adventurers-guide.md"
Cohesion: 0.42
Nodes (3): US-39 — Identidade narrativa do personagem, US-43 — Calibração do peso dos traços de identidade, US-45 — Background visível na ficha do personagem

### Community 278 - "AGENTS.md"
Cohesion: 0.25
...
### Community 279 - "character.service.test.ts"
Cohesion: 0.25
...
### Community 281 - "Repositórios de referência — registro e regra de uso"
Cohesion: 0.33
...
## Knowledge Gaps
- **1798 isolated node(s):** `config`, `Recorded`, `CreateAdventureDto`, `ADR-0002`, `História` (+1793 more)
...
- **Why does `US-47 — Ingestão do SRD 5e (2024) como dado do sistema` connect `US-105-raca-e-classe-por-chave-do-srd.md` to `backlog-motor-de-geracao-de-aventuras.md`, `US-110-tabela-de-testes-de-habilidade-do-srd-2024.md`, `US-121-catalogo-backgrounds-a5e-adventurers-guide.md`, `backlog-aventuras-autorais-lazygm.md`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `CharacterService` connect `CharacterService` to `character.service.ts`, `AdventureService`, `AuthUser`, `PrismaService`, `character.service.test.ts`, `CharacterController`?**
